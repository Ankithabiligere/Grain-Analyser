...
def dd(img):
    ...
    # print("width & length",rect[1][0])
     ...
     #print("points",points)
        ...
        print("Area",ellipse[1][0]*ellipse[1][1])
    ...
    #print([cnt])
        ...
        if  Area > 100 and Area <= 350:
            ...
            print('Single rice',Area) 
            return count1,count2,count3,count4,count5
            
        elif  Area > 350 and Area <= 800:
            count2+=2
            print('2 touching rice',Area)
                           
            return count1,count2,count3,count4,count5               
        elif Area > 800 and Area <= 1000:
            count3+=3
            print('3 touching rice',Area) 
            return count1,count2,count3,count4,count5
        elif Area >1000 and Area <= 1500:
            count4+=4
            print('4 touching rice',Area)
            return count1,count2,count3,count4,count5
        elif Area > 1500 and Area <= 2000:
            count5+=5
            print('5 touching rice',Area)
            return count1,count2,count3,count4,count5
        else:
            pass
        
        #print('Broken rice',count)    
        print('Single rice',count1)
        print('2 touching rice',count2)
        print('3 touching rice',count3)    
        print('4 touching rice',count4)
        print('5 touching rice',count5)
            
        print('total rice count',count1+count2+count3+count4+count5)
